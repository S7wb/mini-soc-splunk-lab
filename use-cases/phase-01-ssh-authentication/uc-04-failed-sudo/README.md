...
![Failed sudo Attempts](evidence/01-attack-simulation.png)

#### 2. Raw sudo Event Ingested into Splunk

![Raw sudo Event in Splunk](evidence/02-raw-authentication-event.png)

#### 3. SPL Detection Result

![SPL Detection Result](evidence/03-spl-field-extraction.png)

#### 4. Detection Threshold Validation

![Detection Threshold Validation](evidence/04-spl-threshold-results.png)

#### 5. Alert Configuration

![Alert Configuration](evidence/05-alert-configuration.png)

#### 6. Alert Saved Successfully

![Alert Saved Successfully](evidence/06-alert-saved.png)

#### 7. Triggered Alert

![Triggered Alert](evidence/07-alert-triggered.png)

#### 8. Triggered Alert Result

![Triggered Alert Result](evidence/08-triggered-alert-results.png)

#### 9. sudo Authentication Investigation

![sudo Authentication Investigation](evidence/09-investigation-authentication-failures.png)

#### 10. No Successful sudo Session

![No Successful sudo Session](evidence/10-investigation-no-root-session.png)
