...
[Phase index](../README.md) · [Detection SPL](detection.spl) · [Alert configuration](alert-configuration.md) · [Incident report](incident-report.md) · [Evidence](evidence/README.md) · [Account lookup](privileged_accounts.csv)
...
```text
use-cases/phase-01-ssh-authentication/uc-05-privileged-login/privileged_accounts.csv
```
...
![Privileged Account Verification](evidence/01-privileged-account-verification.png)

### Successful Privileged SSH Login

![Successful Privileged SSH Login](evidence/02-positive-test-ssh-login.png)

### Raw Authentication Log

![Privileged Login Raw Log](evidence/03-positive-test-raw-auth-log.png)

### Splunk Log Ingestion

![Splunk Raw Login Event](evidence/04-positive-test-splunk-ingestion.png)

### Non-Privileged Account Verification

![Non-Privileged Account Verification](evidence/05-non-privileged-account-verification.png)

### Negative Test — Successful SSH Login

![Negative Test SSH Login](evidence/06-negative-test-ssh-login.png)

### Negative Test — Raw Authentication Log

![Negative Test Raw Log](evidence/07-negative-test-raw-auth-log.png)

### Negative Test — Splunk Ingestion

![Negative Test Splunk Event](evidence/08-negative-test-splunk-ingestion.png)

### Negative Test — Detection Validation

![Negative Test Detection Validation](evidence/09-prototype-hardcoded-positive-check.png)

### Privileged Accounts Lookup

![Privileged Accounts Lookup](evidence/10-privileged-accounts-lookup.png)

### Final Detection Results

![Final Detection Results](evidence/11-lookup-based-detection-results.png)

### Alert Configuration

![Alert Configuration](evidence/12-alert-configuration.png)

### Triggered Alert

![Triggered Alert](evidence/13-alert-triggered.png)

### Triggered Alert Results

![Triggered Alert Results](evidence/14-triggered-alert-results.png)

### Investigation Timeline

![Investigation Timeline](evidence/15-investigation-timeline.png)

### Investigation Context

![Investigation Context](evidence/16-investigation-context.png)
