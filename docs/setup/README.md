...
[Project overview](../../README.md) · [Ingestion evidence](assets/01-splunk-auth-log-ingestion.png) · [Architecture](../architecture/README.md)
...
```text
use-cases/phase-01-ssh-authentication/uc-01-ssh-bruteforce/detection.spl
```
